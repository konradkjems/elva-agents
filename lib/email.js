...
export async function sendManualReviewEmail({
  ...
  try {
    const { data, error } = await resend.emails.send({
      ...
      to: [supportEmail],
      subject: `Manual Review Request - ${widgetName}`,
      html: `
        <!DOCTYPE html>
        <html>
          <head>
            ...
            <title>Manual Review Request - Elva Solutions</title>
            <style>
              body {
            ...
            <div class="email-wrapper">
              <div class="email-container">
                <div class="header">
                  ...
                  <h1>Manual Review Request 🔍</h1>
                  <p>New request requires your attention</p>
                </div>
                
                <div class="content">
                  <p style="font-size: 16px; margin-bottom: 24px;">Hi Support Team,</p>
                  
                  <p style="font-size: 16px;">A user has requested manual review for their conversation with the AI assistant.</p>
                  
                  <div class="review-card">
                    <div class="review-detail">
                      <span>👤 <strong>Contact Name:</strong> ${contactName || 'Not provided'}
                    </div>
                    <div class="review-detail">
                      <span>📧 <strong>Contact Email:</strong> ${contactEmail}
                    </div>
                    <div class="review-detail">
                      <span>🤖 <strong>Widget:</strong> ${widgetName}
                    </div>
                    <div class="review-detail">
                      <span>🏢 <strong>Organization:</strong> ${organizationName}
                    </div>
                    <div class="review-detail">
                      <span>🆔 <strong>Review ID:</strong> ${reviewId}
                    </div>
                    <div class="review-detail">
                      <span>💬 <strong>Conversation ID:</strong> ${conversationId}
                    </div>
                    <div class="review-detail">
                      <span>📅 <strong>Submitted:</strong> ${new Date().toLocaleString('da-DK')}
                    </div>
                  </div>
                  ...
                  <div style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 16px; border-radius: 6px; font-size: 14px; color: #92400e;">
                    <strong>⚠️ Action Required:</strong> Please review this request in the admin dashboard and respond to the user within 24 hours.
                  </div>
                </div>
